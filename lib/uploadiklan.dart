...
import 'package:pngajar/succsessiklan.dart';// Import the SuccessPage

class UploadIklan extends StatelessWidget {
  @override
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => SuccessIklan()),
                  );
                },
                child: Text(
                  'Unggah',
